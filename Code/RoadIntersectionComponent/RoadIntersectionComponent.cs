...
public partial class RoadIntersectionComponent : Component, Component.ExecuteInEditor
{
	...
	[Property(Title = "Width"), Category("Sidewalk"), Order(3)] private float SidewalkWidth { get; set { field = value; m_MeshBuilder?.IsDirty = true; } } = 50f;
	[Property(Title = "Height"), Category("Sidewalk"), Order(3)] private float SidewalkHeight { get; set { field = value; m_MeshBuilder?.IsDirty = true; } } = 5f;
	[Property(Title = "Texture Repeat"), Category("Sidewalk"), Order(3)] private float SidewalkTextureRepeat { get; set { field = value; m_MeshBuilder?.IsDirty = true; } } = 100.0f;
